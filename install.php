...
class tpl_hydrogen_ramblersInstallerScript
{
	...
	{
			JFactory::getApplication()->enqueueMessage('Ramblers customisation of Hydrogen Template is being installed.');
	}
    /**
    ...
    public function uninstall($parent)
    {
		...
		JFactory::getApplication()->enqueueMessage('Ramblers customisation of the Hydrogen Template is being removed.');
